...
(function () {
  var plus = document.querySelectorAll('.btn--plus'),
      ...
      adultCount = adult.querySelector('#adultCount'),
      children = document.querySelector('#children'),
      childrenCount = children.querySelector('#childrenCount'),
      dateIn = document.querySelector('#datepickerIn'),
      dateOut = document.querySelector('#datepickerOut');

  dateIn.readOnly = true;
  dateOut.readOnly = true;
  adultCount.readOnly = true;
  childrenCount.readOnly = true;
  adultCount.disabled = true;
  childrenCount.disabled = true;

  adult.addEventListener('click', function (e) {
    e.preventDefault();
  });
  ...
  plus[0].addEventListener('click', function (e) {
    if (adultCount.value < 10) {
      adultCount.setAttribute('value', +adultCount.getAttribute('value') + 1);
    }
  });
  ...
  plus[1].addEventListener('click', function () {
    if (childrenCount.value < 10) {
      childrenCount.setAttribute('value', +childrenCount.getAttribute('value') + 1);
    }
  });
...
(function () {
  var pageNav = document.querySelector('.page-nav'),
      menu = pageNav.querySelector('.page-nav_mobile'),
      menuOpen = pageNav.querySelector('.page-nav_burger'),
      menuClose = document.querySelector('.page-nav_close');
...
(function () {
  ...
  if (def.indexOf('re:11.0') >= 0 || def.indexOf('.NET4.0E') >= 0 || def.indexOf('.NET4.0C') >= 0 || def.indexOf('Trident/7.0') >= 0) {
    sryButUUseIE.forEach(function(elem) {elem.style.display = 'none'});
  }
})();
...
(function () {
  ...
  var pickerIn = new Pikaday(
    {
      field: document.getElementById('datepickerIn'),
      firstDay: 1,
      format: 'D MMMM YYYY',
      minDate: new Date(),
      ...
      yearRange: [2017,2030],
      onSelect: function() {
        var dateIn = this.getDate();
        pickerOut._o.minDate = dateIn;
      }
    });
  var pickerOut = new Pikaday(
    {
      field: document.getElementById('datepickerOut'),
      firstDay: 1,
      format: 'D MMMM YYYY',
      minDate: new Date(),
      maxDate: new Date(2030, 12, 31),
